...
export const FlagIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z" /><line x1="4" y1="22" x2="4" y2="15" /></IconWrapper>;
...
export const GridCopyIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></IconWrapper>;
export const CursiveIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M14 16.5c-2 0-3-1-4.5-1.5s-3-1.5-3.5-3c-.5-1.5.5-3 2.5-3s5 2 5 2m-8 7s-1-1-1-2c0-2 2-2 3-2s3 1 3 1"/></IconWrapper>;
export const UnscrambleIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M14 5l3 3-3 3"/><path d="M17 8H3"/><path d="M10 19l-3-3 3-3"/><path d="M7 16h14"/><path d="M17 12l4-4"/><path d="M3 12l4 4"/></IconWrapper>;

// Dyslexia Module Icons
export const PhonologicalAwarenessIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M15.5 6.5c1.5-1.5 4-1.5 5.5 0s1.5 4 0 5.5L12 21 2.5 12.5c-1.5-1.5-1.5-4 0-5.5s4-1.5 5.5 0L12 11.5Z"/><path d="m14 10-2-2-2 2"/><path d="M12 8V2"/></IconWrapper>;
export const LetterSoundIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M4 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M16 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M20 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M4 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M8 16a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M12 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M16 16a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/></IconWrapper>;
export const ReadingFluencyIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></IconWrapper>;
export const ComprehensionIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/><path d="M12 8v4"/><path d="M12 16h.01"/></IconWrapper>;
export const VocabularyIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M14 22v-4a2 2 0 1 0-4 0v4"/><path d="M18 22V8.5a4.5 4.5 0 0 0-9 0V22"/><path d="M2 22V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v17"/></IconWrapper>;
export const MorphologyIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M10 10-4.5 20.5"/><path d="m14 10 4.5 10.5"/><path d="M10 10c-2.2.8-4.5 2-6 3.5"/><path d="m14 10 6 3.5"/><path d="M10 10c-5.5 0-8 4-8 4"/><path d="m14 10 8 4"/><path d="M12 2v8"/><path d="m10 10-2 2.5"/><path d="m14 10 2 2.5"/></IconWrapper>;
export const SentenceBuilderIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M13 4H7a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6"/><path d="m21 6-9 9"/><path d="M17 2h4v4"/></IconWrapper>;
export const ExecutiveFunctionIcon: React.FC<IconProps> = (props) => <IconWrapper {...props}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="m9 12 2 2 4-4"/></IconWrapper>;
