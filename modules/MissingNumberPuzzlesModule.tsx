...
import { MissingNumberPuzzlesSettings, ModuleKey } from '../types.ts';
...
const MissingNumberPuzzlesModule: React.FC = () => {
    ...
    const settings = allSettings.missingNumberPuzzles;
    const moduleKey: ModuleKey = 'missingNumberPuzzles';
