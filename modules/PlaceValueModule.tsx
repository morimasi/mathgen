...
const PlaceValueModule: React.FC<ModuleProps> = ({ onGenerate, setIsLoading, worksheetRef, autoRefreshTrigger, lastGeneratorModule }) => {
    ...
    const handleGenerate = useCallback(async (clearPrevious: boolean) => {
        ...
        try {
            ...
            if (settings.useWordProblems) {
                ...
                onGenerate(problems, clearPrevious, title, 'place-value');
