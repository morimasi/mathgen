...
import GridCopySettings from './dysgraphia/GridCopySettings.tsx';
import CursivePracticeSettings from './dysgraphia/CursivePracticeSettings.tsx';
import SentenceUnscrambleSettings from './dysgraphia/SentenceUnscrambleSettings.tsx';
...
const subModuleGroups: {
...
}[] = [
    {
        ...
        modules: [
            ...
            { id: 'math-connect-the-dots', label: 'Noktadan Noktaya', icon: RhythmicIcon },
            { id: 'grid-copy', label: 'Izgara Kopyalama', icon: GridCopyIcon },
        ]
    },
    {
        title: "Harf ve Yazı Atölyesi",
        modules: [
            ...
            { id: 'cursive-practice-ai', label: 'El Yazısı Pratiği (AI)', icon: CursiveIcon },
        ]
    },
    {
        title: "Yazılı Anlatım (AI)",
        modules: [
            ...
            { id: 'sentence-unscramble-ai', label: 'Cümle Düzenleme', icon: UnscrambleIcon },
        ]
    }
];
...
const defaultSettings: DysgraphiaSettings = {
    ...
    sentenceUnscrambleAi: { gradeLevel: 2, sentenceLength: 'short' },
};
...
const DysgraphiaModule: React.FC = () => {
    ...
    const renderSettingsPanel = () => {
        ...
        switch (activeSubModuleId) {
            ...
            case 'grid-copy': return <GridCopySettings {...props} />;
            ...
            case 'cursive-practice-ai': return <CursivePracticeSettings {...props} />;
            ...
            case 'sentence-unscramble-ai': return <SentenceUnscrambleSettings {...props} />;
            default: return null;
        }
    };
