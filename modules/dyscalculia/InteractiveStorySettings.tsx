...
import { InteractiveStoryDcSettings } from '../../types.ts';
        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                <Select
                    ...
                    onChange={e => onChange({ gradeLevel: e.target.value as InteractiveStoryDcSettings['gradeLevel'] })}
                    options={[
