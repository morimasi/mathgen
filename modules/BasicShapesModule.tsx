    ...
    return (
        <div className="space-y-2">
            <div className="flex items-center gap-2">
                ...
                <HintButton text="'Şekil Boyama, Sayma ve Eşleştirme'nin yanı sıra artık 'Şeklin Üzerinden Git' ile motor becerileri, 'Şekil Özellikleri' ile de kenar/köşe sayısı gibi kavramları öğretebilirsiniz." />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-2 gap-y-1.5">
                <Select
                    ...
                    options={[
                        ...
                        { value: ShapeRecognitionType.TraceShape, label: 'Şeklin Üzerinden Git' },
                        { value: ShapeRecognitionType.ShapeProperties, label: 'Şekil Özellikleri' },
                    ]}
