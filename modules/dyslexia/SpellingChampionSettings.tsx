...
// FIX: Changed import from non-existent SpellingChampionSettings to the correct SpellingSettings.
import { SpellingSettings } from '../../types.ts';
import Select from '../../components/form/Select.tsx';
import HintButton from '../../components/HintButton.tsx';

interface Props {
    settings: SpellingSettings;
    onChange: (settings: Partial<SpellingSettings>) => void;
}
        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
                <Select
                    ...
                    onChange={e => onChange({ category: e.target.value as SpellingSettings['category'] })}
                    options={[
                ...
                <Select
                    ...
                    onChange={e => onChange({ difficulty: e.target.value as SpellingSettings['difficulty'] })}
                    options={[
