...
// FIX: Changed import from non-existent VocabularyExplorerSettings to the correct VocabularySettings.
import { VocabularySettings } from '../../types.ts';
import Select from '../../components/form/Select.tsx';
import HintButton from '../../components/HintButton.tsx';

interface Props {
    settings: VocabularySettings;
    onChange: (settings: Partial<VocabularySettings>) => void;
}
        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
                <Select
                    ...
                    onChange={e => onChange({ gradeLevel: e.target.value as VocabularySettings['gradeLevel'] })}
                    options={[
                ...
                <Select
                    ...
                    onChange={e => onChange({ difficulty: e.target.value as VocabularySettings['difficulty'] })}
                    options={[
