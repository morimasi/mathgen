...
// FIX: Changed import from non-existent AuditoryWritingSettings to AuditoryWritingSettings from types.
import { AuditoryWritingSettings as AuditoryWritingSettingsType } from '../../types.ts';
import Select from '../../components/form/Select.tsx';
import HintButton from '../../components/HintButton.tsx';

interface Props {
    settings: AuditoryWritingSettingsType;
    onChange: (settings: Partial<AuditoryWritingSettingsType>) => void;
}
        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
                <Select
                    ...
                    id="aw-type"
                    value={settings.type}
                    onChange={e => onChange({ type: e.target.value as AuditoryWritingSettingsType['type'] })}
                    options={[
                ...
                <Select
                    ...
                    onChange={e => onChange({ difficulty: e.target.value as AuditoryWritingSettingsType['difficulty'] })}
                    options={[
